...
export default function LineNode({ id, isConnectable, selected }: any) {
  ...
  return (
    <>
      ...
      <div className={`group py-4 px-2 min-w-[200px] w-full h-full flex items-center justify-center cursor-pointer transition-all ${selected ? 'ring-2 ring-slate-400 rounded-md bg-white/50' : ''}`}>
